 ...
 * 每阶段: key/title/short/spineNodes/features/prompt/explanation/codeRef
 * short 为时间轴标签用的简短标题；features 一旦开启保持开启（视觉上逐步完善）。
 */
(function (root, factory) {
  ...
  return [
    {
      key: 'anchor', title: '0 · 移动锚点', short: '光点', spineNodes: 1,
      features: feats([]),
    ...
    {
      key: 'spine_short', title: '1 · 短脊椎链(6节)', short: '短链', spineNodes: 6,
    ...
    {
      key: 'spine_long', title: '2 · 长脊椎链(12节)', short: '长链', spineNodes: 12,
      features: feats(['spine']),
    ...
    {
      key: 'spine_ik', title: '3 · 更长脊椎 + IK 腿部', short: 'IK关节', spineNodes: 20,
    ...
    {
      key: 'skin_outline', title: '4 · 头部 + 身体轮廓', short: '皮肤', spineNodes: 20,
    ...
    {
      key: 'bodyform', title: '5 · 体型曲线', short: '体形', spineNodes: 20,
    ...
    {
      key: 'collision', title: '6 · 防止自碰撞', short: '防自碰', spineNodes: 20,
    ...
    {
      key: 'serpentine', title: '7 · 蛇形摆动', short: '蛇形', spineNodes: 20,
    ...
    {
      key: 'vision', title: '10 · 视野锥 + 光点', short: '视野', spineNodes: 20,
    ...
    {
      key: 'battle', title: '11 · 战斗动作', short: '捕食', spineNodes: 20,
    ...
    {
      key: 'params', title: '12 · 参数化', short: '自定义外观', spineNodes: 20,
