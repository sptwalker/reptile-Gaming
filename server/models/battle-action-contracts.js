...
const ACTION_CONTRACTS = {
    ...
    guard: { actionId: 'guard', type: 'defense', duration: 22, windup: 2, impact: 7, recover: 6, pose: 'guard', priority: 62, staminaCost: 4, cooldown: 66, interruptible: false, armor: 0.26, counterWindow: { start: 7, end: 12 }, tags: ['defense', 'counter_ready'] },
    brace: { actionId: 'brace', type: 'defense', duration: 26, windup: 4, impact: 10, recover: 7, pose: 'brace', priority: 60, staminaCost: 5, cooldown: 96, interruptible: false, armor: 0.38, counterWindow: { start: 10, end: 15 }, tags: ['defense', 'anti_heavy'] },
